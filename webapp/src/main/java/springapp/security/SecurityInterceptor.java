...
/**
 * This interceptor injects the security context into the model.
 * 
 * It is activated in webmvc-config.xml via
 * <code>
 * <mvc:interceptors>
 *   ...
 *   <bean class="springapp.security.SecurityInterceptor"/>
 * </mvc:interceptors>
 * </code>
 * 
 * The other interceptors were generated by roo, let's hope this one won't be overwritten.
 * 
 * @author uk
 *
 */
